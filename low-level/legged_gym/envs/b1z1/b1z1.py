...
class B1Z1(LeggedRobot):
    def _reset_dofs(self, env_ids):
        ...
        """
        print(self.cfg.asset.dof_names)
        print()
        print(self.dof_names)
        print(len(self.dof_names), len(self.motor_dofs), len(self.cfg.asset.dof_names), self.dof_pos[env_ids].shape, self.num_actions)
    ...
    def _compute_torques(self, actions):
        ...
        print(actions.shape, action_scale.shape)
